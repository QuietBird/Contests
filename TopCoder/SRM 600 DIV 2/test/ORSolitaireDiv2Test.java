...
public class ORSolitaireDiv2Test {
    ...
    @Test(timeout=2000)
    public void test5() {
        int[] numbers = new int[] {109127425, 391193886, 77568450, 481751837, 411889236, 488364804, 480598915, 7490879, 95057181, 16530444, 55580676, 92339390, 273649157, 5737290, 144995698, 480240667, 402927632, 95353526, 170311435, 485081164};
        int goal =  536870911;
        assertEquals(4, new ORSolitaireDiv2().getMinimum(numbers, goal));
    }
